                ...
                <tbody>
                    {classes.map((item, index) => (
                        <tr key={item.class_id || item.id || index}>
                            <td className="w-12 px-2 py-2 text-center border">{index + 1}</td>
                            <td className="w-56 px-4 py-2 border">{item.class_name || item.nama || '-'}</td>
                            ...
                            <td className="w-32 px-2 py-2 border">
                                <div className="flex justify-center gap-2">
                                    ...
                                    <div className="flex flex-col items-center">
                                        ...
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.232 5.232l3.536 3.536M9 13l6.586-6.586a2 2 0 112.828 2.828L11.828 15.828a2 2 0 01-2.828 0L9 13zm0 0v2a2 2 0 002 2h2" />
                                            </svg>
                                            Edit
                                        </Link>
                                    </div>
                                        ...
                                        <button
                                            onClick={() => {
                                                if (window.confirm('Yakin hapus data ini?')) {
                                                    ...
                                                    console.log('Delete', item.class_id || item.id);
                                                }
                                            }}
                                            className="flex flex-col items-center"
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 mb-1 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" />
                                            </svg>
                                            <span className="text-red-600 hover:underline">Hapus</span>
                                        </button>
                                    </div>
                                </div>
                            </td>
